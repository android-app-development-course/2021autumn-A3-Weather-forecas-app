    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        aboutFAB.setOnClickListener {
            androidx.appcompat.app.AlertDialog.Builder(this)
                .setTitle("关于")
                .setMessage("好天气：一个开源的 Android 天气预报 APP\n\n"+
        ...
        emailMeAbout.setOnClickListener {
            val emailIntent = Intent(Intent.ACTION_SENDTO).apply {
                ...
                putExtra(Intent.EXTRA_SUBJECT,"Goodweather反馈")
            }
        ...
        githubIssuesAbout.setOnClickListener {
            ...
            githubIntent.data = Uri.parse("https://github.com")
            startActivity(githubIntent)
        }

        marketAbout.setOnClickListener {
            val marketIntent = Intent(Intent.ACTION_VIEW)
            marketIntent.data = Uri.parse("https://github.com")
        ...
        icons8About.setOnClickListener {
            ...
            icons8Intent.data = Uri.parse("https://github.com/")
        ...
        weatherAnimationAbout.setOnClickListener {
            ...
            weatherAnimationIntent.data = Uri.parse("https://github.com")
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when(item.itemId){
            ...
            R.id.mainPageAbout -> {
                ...
                mainPageIntent.data = Uri.parse("https://github.com")
                startActivity(mainPageIntent)
            }

            R.id.coolapkContact -> {
                val coolapkIntent = Intent(Intent.ACTION_VIEW)
                coolapkIntent.data = Uri.parse("https://github.com")
                startActivity(coolapkIntent)
            }

            R.id.blogContact -> {
                val blogIntent = Intent(Intent.ACTION_VIEW)
                blogIntent.data = Uri.parse("https://github.com")
